...
class KBotLegsV2(BaseRobotHumanoid):
    """
    Mujoco environment of the KBotLegsV2 robot.
    """
    ...
    def _get_observation_specification(spec: MjSpec) -> List[Observation]:
        ...
        """
        # Adapt joint names based on your ../../../../scene/kbot_legs_in_scene.xml
    ...
    def _get_action_specification(spec: MjSpec) -> List[str]:
        ...
        """
        # Adapt motor names based on your ../../../../scene/kbot_legs_in_scene.xml
        action_spec = [
    ...
    def get_default_xml_file_path(cls) -> str:
        """
        Returns the default XML file path for the KBotLegsV2 environment.
        """
        return (loco_mujoco.PATH_TO_MODELS / "kbot_v2" / "kbot_legs_v2.xml").as_posix()

    @info_property
    def sites_for_mimic(self) -> List[str]:
        """
        Returns the default sites that are used for mimic. Needs to match the sites added in ../../../../scene/kbot_legs_in_scene.xml.
        """
        return [
            "pelvis_mimic",
            "left_hip_mimic",
